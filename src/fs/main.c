...
/*开始新增*/
		 ...
		 case DUP: 
		 	...
		 	break; 
		 case FLOCK: 
		 	fs_msg.RETVAL = do_flock(); 
		 	break; 
		 case PWRITE: 
			//printf("what?");
		 	fs_msg.CNT = do_pwrite(); 
			//printf("\n%d\n",fs_msg.CNT);
		 	break; 
		 case PREAD: 
		 	fs_msg.CNT = do_pread(); 
		 	break;
		 case READV: 
		 	fs_msg.RETVAL = do_readv(); 
		 	break;
		 case WRITEV: 
		 	fs_msg.RETVAL = do_writev(); 
		 	break;
/*新增结束*/
		 default:
...
/*开始新增*/
		msg_name[DUP]   = "DUP";	
		msg_name[STAT]   = "STAT"; 
		msg_name[FLOCK]   = "FLOCK"; 
		msg_name[PREAD]   = "PREAD"; 
		msg_name[PWRITE]   = "PWRITE"; 
		msg_name[READV]   = "PREADV"; 
		msg_name[WRITEV]   = "WRITEV"; 
/*新增结束*/
		switch (msgtype) {
		case CLOSE:
		case UNLINK:
